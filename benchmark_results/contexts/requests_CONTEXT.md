...
graph LR
    ...
    f4["src/requests/_internal_utils.py"]
    f5["src/requests/exceptions.py"]
    f6["src/requests/utils.py"]
    f7["src/requests/auth.py"]
    f8["src/requests/models.py"]
    f9["src/requests/adapters.py"]
    f10["src/requests/hooks.py"]
    f11["src/requests/sessions.py"]
    f12["tox.ini"]
    f13["src/requests/__version__.py"]
    f14["src/requests/status_codes.py"]
    f15["pyproject.toml"]
    f16["requirements-dev.txt"]
    f17["setup.py"]
    f18["ext/requests-logo.svg"]
    f19["src/requests/help.py"]
    f20["src/requests/api.py"]
    f21["src/requests/certs.py"]
    f22["src/requests/packages.py"]
    f23[".gitignore"]
    f24[".pre-commit-config.yaml"]
    f1 --> f0
    f2 --> f0
    f2 --> f4
    f3 --> f14
...
|------|-------|------|--------|
| `src/requests/compat.py` | 0.511 | structured summary | 36 |
| `src/requests/structures.py` | 0.357 | structured summary | 103 |
| `src/requests/cookies.py` | 0.326 | structured summary | 183 |
| `src/requests/__init__.py` | 0.326 | structured summary | 85 |
| `src/requests/_internal_utils.py` | 0.296 | structured summary | 79 |
| `src/requests/exceptions.py` | 0.296 | structured summary | 177 |
| `src/requests/utils.py` | 0.265 | structured summary | 145 |
| `src/requests/auth.py` | 0.234 | structured summary | 170 |
| `src/requests/models.py` | 0.234 | structured summary | 183 |
| `tests/testserver/server.py` | 0.217 | one-liner | 26 |
| `src/requests/adapters.py` | 0.203 | structured summary | 168 |
| `src/requests/hooks.py` | 0.203 | structured summary | 55 |
| `src/requests/sessions.py` | 0.203 | structured summary | 171 |
| `tox.ini` | 0.200 | signatures | 14 |
| `tests/certs/valid/server/cert.cnf` | 0.196 | one-liner | 18 |
| `tests/certs/valid/server/server.csr` | 0.196 | one-liner | 17 |
| `tests/conftest.py` | 0.196 | one-liner | 21 |
| `tests/test_adapters.py` | 0.196 | one-liner | 21 |
| `tests/test_help.py` | 0.196 | one-liner | 24 |
| `tests/test_hooks.py` | 0.196 | one-liner | 20 |
| `tests/test_lowlevel.py` | 0.196 | one-liner | 21 |
| `tests/test_packages.py` | 0.196 | one-liner | 20 |
...
| `tests/test_utils.py` | 0.196 | one-liner | 25 |
| `tests/testserver/__init__.py` | 0.196 | one-liner | 15 |
| `tests/certs/valid/server/Makefile` | 0.195 | one-liner | 17 |
| `tests/certs/mtls/client/cert.cnf` | 0.195 | one-liner | 19 |
| `tests/certs/mtls/client/client.csr` | 0.195 | one-liner | 18 |
| `tests/certs/mtls/README.md` | 0.194 | one-liner | 17 |
| `tests/certs/mtls/client/Makefile` | 0.194 | one-liner | 18 |
| `tests/certs/expired/server/cert.cnf` | 0.193 | one-liner | 18 |
| `tests/certs/expired/server/server.csr` | 0.193 | one-liner | 17 |
| `tests/certs/mtls/Makefile` | 0.193 | one-liner | 17 |
| `tests/certs/expired/ca/ca.cnf` | 0.192 | one-liner | 17 |
| `tests/certs/expired/ca/ca.srl` | 0.192 | one-liner | 17 |
| `tests/certs/expired/server/Makefile` | 0.192 | one-liner | 17 |
| `tests/certs/expired/README.md` | 0.192 | one-liner | 16 |
| `tests/certs/expired/ca/Makefile` | 0.192 | one-liner | 17 |
